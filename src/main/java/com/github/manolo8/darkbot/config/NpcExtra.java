...
public enum NpcExtra implements NpcExtraFlag {
    NO_CIRCLE, IGNORE_OWNERSHIP, IGNORE_ATTACKED, IGNORE_BOXES, AGGRESSIVE_APPROACH, AGGRESSIVE_FOLLOW, PASSIVE, ATTACK_SECOND, LEECH_ONLY, NO_SAB, USE_RSB, PET_LOCATOR;
