...
public class DarkBoatAdapter extends GameAPIImpl<DarkBoat, DarkBoat, DarkBoat, ByteUtils.StringReader, DarkBoat> {

    private DarkBoatAdapter(StartupParams params, DarkBoat darkboat) {
        super(params, darkboat, darkboat, darkboat, new ByteUtils.StringReader(darkboat), darkboat,
