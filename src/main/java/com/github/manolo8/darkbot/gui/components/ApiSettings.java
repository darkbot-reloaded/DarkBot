...
public class ApiSettings extends JDialog {

    public ApiSettings(Main main, Point p) {

        add(new ApiSettingsPanel(main.config.BOT_SETTINGS.DISPLAY));
    ...
    private class ApiSettingsPanel extends JPanel {

        private final Config.BotSettings.Display display;
        private final JSpinner w, h;

        public ApiSettingsPanel(Config.BotSettings.Display display) {
            ...
            ApiSettings.super.getRootPane().setDefaultButton(apply);
