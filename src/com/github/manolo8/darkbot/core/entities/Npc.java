...
public class Npc extends Ship {
    ...
    static {
        ...
        npcType.put(10, new NpcType("Kristallon", 680));
...
//        npcType.put(160, new NpcType("Blighted Kristallon.", 780));
        ...
        ggAlpha.put(10, new NpcType("Kristallon α", 680));
        ...
        ggBeta.put(10, new NpcType("Kristallon β", 680));
        ...
        ggGamma.put(10, new NpcType("Kristallon γ", 680));
    ...
    public Npc(long address, int id) {
        super(address, id);
    ...
    public boolean isInvalid() {
        if (super.isInvalid()) return true;

        return health.maxHp != 0 && health.hp == 0;
    }
}
